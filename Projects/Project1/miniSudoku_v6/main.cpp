...
//v.6 ~ Additional conditions
        switch player.name from string to char                         - DONE!
        switch i/o files to binary                                     - DONE!
        declare a local pointer variable that points to board          - DONE!
        utilize pointers                                               - DONE!
        utilize memory allocation                                      - DONE!
        utilize delete operator                                        - DONE!
        Game is now fully functional! Enjoy!
*/
